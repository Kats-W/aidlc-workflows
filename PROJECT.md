...
電話・チャットの問い合わせを、公開ウェブ情報（HTML ページ由来の ~15,000 チャンク。
PDF/画像などの非HTMLノイズは除外）に基づき Claude が回答し、答えられない場合は人間
オペレーターへエスカレーションします。
...
- **コーパス浄化** — クローラーの非HTMLスキップ導入前に埋め込まれた PDF/画像チャンクが
  ...
  （FX アプリ手動 PDF 1本で約5,900チャンク）。検索診断で特定し一括パージ → **HTML 由来の
  ~15,000 チャンク**に。ベクトルキャッシュは 531MB → 62MB に縮小（コールド起動も高速化）。
